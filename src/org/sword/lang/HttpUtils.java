...
public class HttpUtils {
    ...
    public static String postFile(String url, String name, File file) {
        try {
            ...
            HttpEntity entity = Request.Post(url).body(reqEntity).execute().returnResponse().getEntity();
            return entity != null ? EntityUtils.toString(entity, "UTF-8") : null;
        } catch (Exception e) {
    ...
    public static byte[] getFile(String url) {
        try {
            HttpEntity resEntity = Request.Get(url).execute().returnResponse().getEntity();
